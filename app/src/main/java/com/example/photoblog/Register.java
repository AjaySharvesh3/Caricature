        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(email) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(confirmPassword)) {
                    ...
                    Toast.makeText(Register.this, "We can't proceed your registration with these empty boxes..! ", Toast.LENGTH_LONG).show();
                    textToSpeech = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                        @Override
                        public void onInit(int status) {
                            textToSpeech.speak("We can't proceed your registration with these empty boxes..! ", TextToSpeech.SUCCESS, null);
                        }
                    });
                }
            }
